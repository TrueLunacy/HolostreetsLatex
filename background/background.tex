\begin{tikzpicture}
    ...
    \ifx\@noimage\undefined
        \ifodd\value{page}
        \includegraphics[width=\paperwidth,height=\paperheight]{\@imageLocation{background-left.png}}
        \else
        \includegraphics[width=\paperwidth,height=\paperheight]{\@imageLocation{background-right.png}}
        \fi
    \fi
    };
    \begin{pgfinterruptboundingbox}
        \ifodd\FirstMark{isChapter}
            ...
            {
                \ifx\@noimage\undefined
                    \includegraphics[width=\paperwidth]{\@imageLocation{chapter-intro.png}}
                \fi
            };
            \ifx\@noimage\undefined
